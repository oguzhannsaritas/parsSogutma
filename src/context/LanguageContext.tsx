...
const translations: Translations = {
  ...
  'product.tabs.options': { TR: 'Opsiyonlar', EN: 'Options' },
  ...
  'product.extra.categories': { TR: 'Kategoriler', EN: 'Categories' },
    ...
    'filters.items.kasapDolabiDuzeCamli': { TR: 'Kasap Reyon Dolabı Düz Camlı', EN: 'Butcher Cabinet (Flat Glass)' },
    ...
    'filters.items.paslanmaz': { TR: 'Paslanmaz', EN: 'Stainless Steel' },
    ...
    'pars.footer.deepFreezers':{TR:'Derin Dondurucular', EN: 'Deep Freezers'},
    'pars.footer.vertical':{TR:'Dikey Reyonlar', EN :'Vertical Counters'},
    'pars.footer.cake':{TR:'Pasta Dolapları', EN : 'Cake Cabinets'},
    'pars.footer.promotions':{TR:'Promosyonlar', EN : 'Promotions'},

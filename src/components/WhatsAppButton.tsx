...
export default function WhatsAppButton() {
    ...
    // Her sayfa değişiminde tekrar göster
    useEffect(() => {
        setIsVisible(true);
    }, [location.key]); // pathname de olur ama key daha garanti
                ...
                {isVisible && (
                    ...
                    >
                        ...
                        <a
                            ...
                            className="bg-[#25D366] hover:bg-[#128C7E] text-white p-2 md:p-3.5 rounded-full shadow-lg transition-transform hover:scale-110 flex items-center justify-center"

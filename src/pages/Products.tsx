...
export default function Products() {
    ...
    const FILTER_TR_VALUE: Record<string, string> = {
        ...
        'filters.items.dikeyTipBuzdolabiPaslanmazCiftKapiliCamli':'Dikey Tip Buzdolabı Paslanmaz Çift Kapılı Camlı',
        'filters.items.paslanmazDikeyTipBuzDolabiCiftKapili':'Paslanmaz Dikey Tip Buzdolabı Çift Kapılı',
        'filters.items.dikeyTipBuzdolabiCiftKapili': 'Dikey Tip Buz Buzdolabı Çift Kapılı',
        ...
        () => [
            ...
            },
            {
                ...
                items: [
                    ...
                    'filters.items.paslanmazDikeyTipBuzDolabiCiftKapili',
